...
gulp.task("beautify", () =>
  gulp.src(["./*.css", "./*.html", "./*.js"]).pipe(beautify())
);
...
gulp.task(
  "watch",
  gulp.series("css", "ampcss", "concat-js", function () {
    browserSync.init({
    ...
    gulp
      ...
      .on("change", gulp.series("ampcss"));
    gulp
      .watch(["./assets/js/**/*.js", "!./assets/js/app.bundle.min.js"], {
        allowEmpty: true,
      })
      .on("change", gulp.series("concat-js", browserSync.reload));
...
gulp.task(
  "build",
  gulp.series("clean", "lint", "css", "concat-js", function () {
    var targetDir = "build/";
